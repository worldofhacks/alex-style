 ...
 */
export type VFXUniformValue = number | [number, number] | [number, number, number] | [number, number, number, number] | number[] | Float32Array | Int32Array | Uint32Array;
/**
 * @internal
 */
 ...
 */
export type EffectTextureSource = WebGLTexture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | ImageBitmap | OffscreenCanvas;
 ...
 */
export type EffectUniformValue = number | boolean | [number, number] | [number, number, number] | [number, number, number, number] | number[] | Float32Array | Int32Array | Uint32Array | EffectTexture | EffectRenderTarget;
export type EffectUniforms = {
    [name: string]: EffectUniformValue;
};
...
export type EffectAttributeTypedArray = Float32Array | Uint8Array | Uint16Array | Uint32Array | Int8Array | Int16Array | Int32Array;
export type EffectAttributeDescriptor = EffectAttributeTypedArray | {
 ...
 */
export type EffectQuad = {
    readonly __brand: "EffectQuad";
};
...
export type EffectContext = {
     ...
     * everything else.
     */
    wrapTexture(source: EffectTextureSource, opts?: {
        size?: readonly [number, number];
        autoUpdate?: boolean;
        wrap?: EffectTextureWrap | readonly [EffectTextureWrap, EffectTextureWrap];
        filter?: EffectTextureFilter;
     ...
     * Only valid during `Effect.render()`; other calls are ignored.
     */
    blit(source: EffectTexture | EffectRenderTarget, target?: EffectRenderTarget | null, opts?: EffectBlitOpts): void;
    /**
