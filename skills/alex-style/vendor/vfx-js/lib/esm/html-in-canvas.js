 ...
 */
export async function setupCapture(canvas, opts) {
 ...
 */
export function teardownCapture(canvas) {
    canvas.onpaint = null;
 ...
 */
export async function wrapElement(element, opts) {
 ...
 */
export function unwrapElement(canvas, element) {
